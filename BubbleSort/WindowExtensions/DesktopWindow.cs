...
namespace BubbleSort.WindowExtensions
{
    ...
    public class DesktopWindow : Window
    {
        ...
        public int Dpi
        {
            get { return (int)Vanara.PInvoke.User32.GetDpiForWindow(_hwnd); }
        }
        ...
        {
            _ = Vanara.PInvoke.User32.ShowWindow(_hwnd, Vanara.PInvoke.ShowWindowCommand.SW_MAXIMIZE);
        }

        public void Minimize()
        {
            _ = Vanara.PInvoke.User32.ShowWindow(_hwnd, Vanara.PInvoke.ShowWindowCommand.SW_MINIMIZE);
        }

        public void Restore()
        {
            _ = Vanara.PInvoke.User32.ShowWindow(_hwnd, Vanara.PInvoke.ShowWindowCommand.SW_RESTORE);
        }
        ...
        {
            _ = Vanara.PInvoke.User32.SetWindowPos(_hwnd, Vanara.PInvoke.User32.SpecialWindowHandles.HWND_TOPMOST, 0, 0, 0, 0,
                Vanara.PInvoke.User32.SetWindowPosFlags.SWP_NOMOVE | Vanara.PInvoke.User32.SetWindowPosFlags.SWP_NOSIZE);
        }
        ...
        private delegate IntPtr WinProc(IntPtr hWnd, Vanara.PInvoke.User32.WindowMessage Msg, IntPtr wParam, IntPtr lParam);
        private WinProc newWndProc = null;
        private IntPtr oldWndProc = IntPtr.Zero;
        [DllImport("user32.dll", EntryPoint = "SetWindowLong")]
        //private static extern IntPtr SetWindowLongPtr32(IntPtr hWnd, Vanara.PInvoke.User32.WindowLongIndexFlags nIndex, WinProc newProc);
        private static extern IntPtr SetWindowLongPtr32(IntPtr hWnd, Vanara.PInvoke.User32.WindowLongFlags nIndex, WinProc newProc);
        [DllImport("user32.dll", EntryPoint = "SetWindowLongPtr")]
        private static extern IntPtr SetWindowLongPtr64(IntPtr hWnd, Vanara.PInvoke.User32.WindowLongFlags nIndex, WinProc newProc);
        // This static method is required because Win32 does not support
        // GetWindowLongPtr directly
        private static IntPtr SetWindowLongPtr(IntPtr hWnd, Vanara.PInvoke.User32.WindowLongFlags nIndex, WinProc newProc)
        {
            if (IntPtr.Size == 8)
        ...
        static extern IntPtr CallWindowProc(IntPtr lpPrevWndFunc, IntPtr hWnd, Vanara.PInvoke.User32.WindowMessage Msg, IntPtr wParam, IntPtr lParam);
        ...
        private void SubClassingWin32()
        {
            ...
            oldWndProc = SetWindowLongPtr(_hwnd, Vanara.PInvoke.User32.WindowLongFlags.GWL_WNDPROC, newWndProc);
        }
        ...
        private void LoadIcon(IntPtr hwnd, string iconName)
        {
            ...
            var hSmallIcon = (int)Vanara.PInvoke.User32.LoadImage(
                IntPtr.Zero,
                iconName,
                Vanara.PInvoke.User32.LoadImageType.IMAGE_ICON,
                Vanara.PInvoke.User32.GetSystemMetrics(Vanara.PInvoke.User32.SystemMetric.SM_CYSMICON),
                Vanara.PInvoke.User32.GetSystemMetrics(Vanara.PInvoke.User32.SystemMetric.SM_CYSMICON),
                Vanara.PInvoke.User32.LoadImageOptions.LR_LOADFROMFILE);

            Vanara.PInvoke.User32.SendMessage(hwnd, (int)Vanara.PInvoke.User32.WindowMessage.WM_SETICON, (IntPtr)ICON_SMALL, hSmallIcon);

            var hBigIcon = (int)Vanara.PInvoke.User32.LoadImage(
                IntPtr.Zero,
                iconName,
                Vanara.PInvoke.User32.LoadImageType.IMAGE_ICON,
                Vanara.PInvoke.User32.GetSystemMetrics(Vanara.PInvoke.User32.SystemMetric.SM_CXICON),
                Vanara.PInvoke.User32.GetSystemMetrics(Vanara.PInvoke.User32.SystemMetric.SM_CYICON),
                Vanara.PInvoke.User32.LoadImageOptions.LR_LOADFROMFILE);

            Vanara.PInvoke.User32.SendMessage(hwnd, (int)Vanara.PInvoke.User32.WindowMessage.WM_SETICON, (IntPtr)ICON_BIG, hBigIcon);
        }

        [StructLayout(LayoutKind.Sequential)]
        private struct MINMAXINFO
        {
            public Vanara.PInvoke.POINT ptReserved;
            public Vanara.PInvoke.POINT ptMaxSize;
            public Vanara.PInvoke.POINT ptMaxPosition;
            public Vanara.PInvoke.POINT ptMinTrackSize;
            public Vanara.PInvoke.POINT ptMaxTrackSize;
        }

        private IntPtr NewWindowProc(IntPtr hWnd, Vanara.PInvoke.User32.WindowMessage Msg, IntPtr wParam, IntPtr lParam)
        {
            switch (Msg)
            {
                ...
                case Vanara.PInvoke.User32.WindowMessage.WM_SETTINGCHANGE:
        ...
        {
            Vanara.PInvoke.User32.SetWindowPos(hwnd, Vanara.PInvoke.User32.SpecialWindowHandles.HWND_TOP,
                                        0, 0, width, height,
        ...
        private void ClipOrCenterRectToMonitorWin32(ref Vanara.PInvoke.RECT prc, bool UseWorkArea, bool IsCenter)
        {
            ...
            //hMonitor = Vanara.PInvoke.User32.MonitorFromRect(ref prc, Vanara.PInvoke.User32.MonitorOptions.MONITOR_DEFAULTTONEAREST);
            hMonitor = Vanara.PInvoke.User32.MonitorFromRect(ref prc, Vanara.PInvoke.User32.MonitorFlags.MONITOR_DEFAULTTONEAREST);
